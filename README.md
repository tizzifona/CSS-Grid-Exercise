...
Este proyecto es un ejercicio de práctica de CSS Grid, realizado según el diseño proporcionado para [Factoría F5](https://factoriaf5.org/). Se enfoca en la implementación de un layout responsivo utilizando técnicas modernas de CSS, con el objetivo de mejorar las habilidades en el diseño web.
